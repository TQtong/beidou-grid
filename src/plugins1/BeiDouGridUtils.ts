...
export default class BeiDouGridUtils {
    ...
    public static encode2D( point:BeiDouGeoPoint, level:number) {
        return BeiDouGridEncoder.encode2D(point, level);
    }
    ...
    public static encode3DHeight(height:number, level:number) {
        return BeiDouGridEncoder.encode3DHeight(height, level);
    }
    ...
    public static encode3D(point:BeiDouGeoPoint, level:number) {
        return BeiDouGridEncoder.encode3D(point, level);
    }
    ...
    public static decode2D(code:string) {
        return BeiDouGridDecoder.decode2D(code);
    }
    ...
    public static decode3D(code:string) {
        return BeiDouGridDecoder.decode3D(code);
    }
     ...
     */
    public static getChildGrids2D(parentGrid:string) {
     ...
     */
    public static getChildGrids3D(parentGrid:string) {
     ...
     */
    public static find2DIntersectingGridCodes(geometry:Geometry, targetLevel:number) {
     ...
     */
    public static find3DIntersectingGridCodes(geometry:Geometry, targetLevel:number, minHeight:number, maxHeight:number) {
        return BeiDouGrid3DRangeQuery.find3DGridCodesInRange(geometry, targetLevel, minHeight, maxHeight);
    }

    public static find3DIntersectingGridCodesWithLineString(lineString:LineString, targetLevel:number) {
